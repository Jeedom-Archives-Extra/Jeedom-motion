			...
			<div role="tabpanel" class="tab-pane" id="MotionDetectionSettings">
				...
				<div class="form-horizontal">
					...
					<div class="form-group">
						...
						<div class="col-md-7">
							<input type="file" name="FileMask" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="mask_file"  data-url="plugins/motion/core/ajax/motion.ajax.php?action=addFileMask" />
						</div>
					</div>
					<div class="form-group">
